...
namespace ThreeStarsandaSun.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventID,EventName,EventAddress,EventDateTime")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventID,EventName,EventAddress,EventDateTime")] Event @event)
        {
            if (id != @event.EventID)
            {
                return NotFound();
